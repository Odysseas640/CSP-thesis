...
crewas: main.o flight_plan.o flight_plan.hpp problemmanager.o array_constraints.o bitset_domain.o expressions.o intvar.o var_constraints.o non_mini_solver_expressions.o non_mini_solver_constraints.o
	$(CC) -o crewas main.o flight_plan.o problemmanager.o array_constraints.o bitset_domain.o expressions.o intvar.o var_constraints.o non_mini_solver_expressions.o non_mini_solver_constraints.o
